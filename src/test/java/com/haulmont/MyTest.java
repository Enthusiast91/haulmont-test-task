...
//            }
    ...
    public static void initDatabase(Statement statement) throws SQLException, IOException {

        try(BufferedReader sqlFileReader = new BufferedReader(new FileReader(pathToSQLDBInitFile));
